...
namespace StudentAPI.Migrations
{
    ...
    [Migration("20200813163658_updateModelInfoSeance")]
    partial class updateModelInfoSeance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentAPI.Core.Models.InfoSeance", b =>
                {
                    ...
                    b.HasIndex("EnseignantId", "JourneeId", "SeanceId", "SalleId")
                        .IsUnique()
                        .HasFilter("[EnseignantId] IS NOT NULL AND [SalleId] IS NOT NULL");
            ...
            modelBuilder.Entity("StudentAPI.Core.Models.InfoSeance", b =>
                {
                    b.HasOne("StudentAPI.Core.Models.Enseignant", "Enseignant")
